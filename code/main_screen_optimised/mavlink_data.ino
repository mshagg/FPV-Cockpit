...
void get_mavlink_data(){
  while (Serial.available() > 0) {
    // Avoid any Serial output before Serial.read, such as Serial.print, as it can interfere with incoming serial data.
       ...
       switch (msg.msgid) {  
        case MAVLINK_MSG_ID_HEARTBEAT:  // #0
        {
          ...
          switch(system_status){
            case 0:
              system_status_str = "UNK";
              break;
            case 1:
              system_status_str = "BOOT";
              break;
            case 2:
              system_status_str = "CAL";
              break;
            case 3:
              system_status_str = "STBY";
              break;
            case 4:
              system_status_str = "ARM";
              break;
            case 5:
              system_status_str = "FAIL";
              break;
            case 6:
              system_status_str = "EMERG";
              break;
            case 7:
              system_status_str = "PWR";
              break;
            case 8:
              system_status_str = "END";
              break;
          }  
          switch (custom_mode){
            case 11:
        ...
        case MAVLINK_MSG_ID_RC_CHANNELS: //needs mavlink V1 to get this data
          {
